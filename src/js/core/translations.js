...
export const STRINGS = {
  es: {
    ...
    'site-hero.sub-html':     '<span class="hero-frase">Cuatro arquetipos. Cuatro universos.</span><span class="hero-frase">Bienvenido al Archivo de Soulware.</span>',
  ...
  en: {
    ...
    'site-hero.sub-html':     '<span class="hero-frase">Four archetypes. Four universes.</span><span class="hero-frase">Welcome to the Soulware Archive.</span>',
