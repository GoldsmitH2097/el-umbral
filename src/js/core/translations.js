...
export const STRINGS = {
  es: {
    ...
    'pacto.accept':           'ACEPTO',
    'aviso.body':             '¿Quieres que te avisemos cuando esté disponible? Déjanos tu email.',
    'aviso.cta':              'AVISADME',
    'aviso.success':          'Hecho. Te escribiremos cuando despierte.',
    'aviso.error':            'No se pudo enviar. Inténtalo de nuevo.',
    'aviso.email-aria':       'Tu correo electrónico para recibir el aviso',
    'aviso.close-aria':       'Cerrar',
    ...
    'tizno.disclaimer':       'En esta web no usamos cookies: no queremos entrometernos en tu vida ni sacar de ti nada que se pueda vender. Tizno recuerda cosas sobre ti, pero las guarda dentro de tu propio dispositivo — nosotros no nos quedamos con nada. Su voz la pone ElevenLabs: cuando hablas con él, tu voz y lo que recuerda de ti viajan a sus servidores para que pueda responderte, bajo su <a href="https://elevenlabs.io/privacy-policy" target="_blank" rel="noopener">política de privacidad</a>.',
    'tizno.olvidar':          'Borrar lo que sabe de ti',
    'tizno.grant-label':      'Su voz, con el apoyo de',
    ...
    // Diagnósticos del micrófono — el remedio tiene que leerse en el idioma
    // del visitante o no es un remedio (auditoría i18n, 6-ago-2026).
    'tizno.micro-vetado':     'el navegador tiene el micrófono vetado en esta web — «aA» en la barra de direcciones → Ajustes del sitio web → Micrófono → Permitir, y recarga',
    'tizno.micro-ausente':    'este aparato no tiene micrófono que prestar',
    'tizno.micro-fallo':      'la página tampoco puede abrir el micrófono: ',
    'tizno.micro-buzon':      'el marco de Tizno aún no está listo para recibir el micrófono',
    'tizno.micro-muerta':     'el micrófono se abrió pero su pista llegó muerta',
    ...
    'site-hero.sub-html':     '<span class="hero-frase hero-frase--inline">Cuatro arquetipos.</span><span class="hero-frase hero-frase--inline">Cuatro universos.</span><span class="hero-frase">Bienvenido al Archivo de Soulware.</span>',
    'site-hero.editorial':    'Soulware es una editorial independiente<br>de ficción oscura y universos de autor.',
  ...
  en: {
    ...
    'aviso.body':             'Want us to tell you when it becomes available? Leave us your email.',
    'aviso.cta':              'NOTIFY ME',
    'aviso.success':          'Done. We will write to you when it wakes.',
    'aviso.error':            'It could not be sent. Try again.',
    'aviso.email-aria':       'Your email to receive the notice',
    'aviso.close-aria':       'Close',
    ...
    'tizno.disclaimer':       'This site uses no cookies: we have no wish to pry into your life or extract anything sellable from you. Tizno remembers things about you, but keeps them inside your own device — we keep nothing. His voice comes from ElevenLabs: when you talk to him, your voice and what he remembers about you travel to their servers so he can answer you, under their <a href="https://elevenlabs.io/privacy-policy" target="_blank" rel="noopener">privacy policy</a>.',
    'tizno.olvidar':          'Erase what he knows about you',
    'tizno.grant-label':      'His voice, supported by',
    ...
    'tizno.micro-vetado':     'the browser has the microphone blocked for this site — “aA” in the address bar → Website Settings → Microphone → Allow, then reload',
    'tizno.micro-ausente':    'this device has no microphone to lend',
    'tizno.micro-fallo':      'the page cannot open the microphone either: ',
    'tizno.micro-buzon':      'Tizno’s frame is not ready to receive the microphone yet',
    'tizno.micro-muerta':     'the microphone opened but its track arrived dead',
