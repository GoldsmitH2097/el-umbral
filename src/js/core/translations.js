...
export const STRINGS = {
  es: {
    ...
    'pago.pagar':             'Pagar',
    'pago.cargando':          'Abriendo el cofre…',
    ...
    'pago.error':             'No se ha podido abrir el pago. Inténtalo de nuevo en un momento.',
    'pago.error-config':      'El pago no está configurado en este entorno',
    'pago.error-titulo':      'El cofre no se abre',
    'pago.ok-titulo':         'Pago recibido',
    'pago.ok-cuerpo':         'La llave llegará a tu correo en unos minutos. Si no aparece, mira en la carpeta de correo no deseado.',
    'pago.pendiente-titulo':  'Pago en camino',
    'pago.pendiente-cuerpo':  'Tu banco aún está confirmando el pago. En cuanto llegue, te enviamos la llave por correo.',
    'pago.fallo-titulo':      'El pago no se completó',
    'pago.fallo-cuerpo':      'No se ha cobrado nada. Puedes volver a intentarlo cuando quieras.',
  ...
  en: {
    ...
    'pago.pagar':             'Pay',
    'pago.cargando':          'Opening the coffer…',
    ...
    'pago.error':             'The payment could not be opened. Please try again in a moment.',
    'pago.error-config':      'Payments are not configured in this environment',
    'pago.error-titulo':      'The coffer will not open',
    'pago.ok-titulo':         'Payment received',
    'pago.ok-cuerpo':         'The key will reach your inbox within a few minutes. If it does not appear, check your spam folder.',
    'pago.pendiente-titulo':  'Payment on its way',
    'pago.pendiente-cuerpo':  'Your bank is still confirming the payment. As soon as it lands, we will email you the key.',
    'pago.fallo-titulo':      'The payment did not go through',
    'pago.fallo-cuerpo':      'Nothing has been charged. You can try again whenever you like.',
