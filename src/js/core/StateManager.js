...
export const CATALOGUE = [
  ...
  },
  {
    ...
    vision: 'La misma historia. Otro peso en las manos. Encuadernación en tela, papel de alto gramaje, ilustraciones que no aparecen en la edición estándar. Para quienes entienden que un libro también es un objeto.',
  ...
  },
  {
    ...
    vision: 'Hay hilos que no deberían conectarse. Cuando lo hacen, la percepción deja de ser tuya. No hay monstruos aquí. Solo la duda, tejida con precisión quirúrgica, hasta que no sabes qué parte de lo que ves es real y qué parte lleva tiempo siendo trampa. Primera de dos novelas.',
